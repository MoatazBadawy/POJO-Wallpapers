...
public class HomeTopFragment extends Fragment implements Picasso.ItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_home_top, container, false);
        arrayList();
        recyclerViewAdapter();
        return rootView;
    }
    ...
    public void recyclerViewAdapter () {
        ...
        int mNoOfColumns = Utility.calculateNoOfColumns(Objects.requireNonNull(getActivity()), 120);
